...
EXPORT_C_FUNC void JuceMixPlayer_onStateUpdate(void* ptr, void (*JuceMixPlayerCallbackString)(const char*));
EXPORT_C_FUNC void JuceMixPlayer_onProgress(void* ptr, void (*onProgress)(float));
EXPORT_C_FUNC void JuceMixPlayer_onError(void* ptr, void (*onError)(const char*));
