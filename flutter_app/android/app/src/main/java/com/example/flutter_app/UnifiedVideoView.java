...
public class UnifiedVideoView implements PlatformView, TextureView.SurfaceTextureListener {
    static {
    ...
    public UnifiedVideoView(@NonNull Context context, int id, @Nullable Map<String, Object> creationParams) {
    ...
    public void dispose() {
        if (playerPtr != 0) {
            nativeSetVideoSurfaceHandle(playerPtr, null);
        }
    ...
    public void onSurfaceTextureAvailable(@NonNull SurfaceTexture surfaceTexture, int width, int height) {
        ...
        if (playerPtr != 0) {
            nativeSetVideoSurfaceHandle(playerPtr, currentSurface);
        }
    }
    ...
    private native void nativeSetVideoSurfaceHandle(long playerPtr, Object surface);
    ...
    public static class Factory extends PlatformViewFactory {
        ...
        public PlatformView create(@NonNull Context context, int viewId, @Nullable Object args) {
            ...
            return new UnifiedVideoView(context, viewId, creationParams);
        }
    }
}
