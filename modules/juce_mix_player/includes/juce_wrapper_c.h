...
EXPORT_C_FUNC void JuceMixPlayer_export(void *ptr, const char *outputPath, void (*completion)(const char *));
...
EXPORT_C_FUNC void UnifiedAVPlayer_setAudioSettings(void *ptr, const char *json);
EXPORT_C_FUNC void UnifiedAVPlayer_resetAudioPlayBuffer(void *ptr);
EXPORT_C_FUNC void UnifiedAVPlayer_exportAudio(void *ptr, const char *outputPath, void (*completion)(const char *));
EXPORT_C_FUNC void UnifiedAVPlayer_setVideoPath(void *ptr, const char *path);
EXPORT_C_FUNC void UnifiedAVPlayer_setVideoSurfaceHandle(void *ptr, void *handle);
EXPORT_C_FUNC void UnifiedAVPlayer_setVideoRotation(void *ptr, int degrees);
EXPORT_C_FUNC void UnifiedAVPlayer_setVideoVisualEffect(void *ptr, int effectId);
EXPORT_C_FUNC void UnifiedAVPlayer_exportVideo(void *ptr, const char *outputPath, void (*completion)(const char *));
...
EXPORT_C_FUNC void UnifiedAVPlayer_onProgress(void *ptr, void (*callback)(void *, float));
EXPORT_C_FUNC void UnifiedAVPlayer_onStateUpdate(void *ptr, void (*callback)(void *, const char *));
EXPORT_C_FUNC void UnifiedAVPlayer_onError(void *ptr, void (*callback)(void *, const char *));
EXPORT_C_FUNC void UnifiedAVPlayer_onDeviceUpdate(void *ptr, void (*callback)(void *, const char *));
